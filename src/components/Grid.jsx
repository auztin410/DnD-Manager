			...
			<div className={this.props.display}>
				<div id={this.props.secondary}>
					{this.state.squares.map((item) => {
						if (item.Terrain === '') {
							return (
								<div className="square" key={item.id} onClick={this.handleClickDown} id={item.id}>
									{item.Player}
								</div>
							);
						} else if (item.Terrain === 'wallH') {
							return (
								<div className="terrainWallH" key={item.id} onClick={this.handleClickDown} id={item.id}>
									{item.Player}
								</div>
							);
						} else if (item.Terrain === 'wallV') {
							return (
								<div className="terrainWallV" key={item.id} onClick={this.handleClickDown} id={item.id}>
									{item.Player}
								</div>
							);
						} else if (item.Terrain === 'water') {
							return (
								<div className="terrainWater" key={item.id} onClick={this.handleClickDown} id={item.id}>
									{item.Player}
								</div>
							);
						} else if (item.Terrain === 'doorH') {
							return (
								<div className="terrainDoorH" key={item.id} onClick={this.handleClickDown} id={item.id}>
									{item.Player}
								</div>
							);
						} else if (item.Terrain === 'doorV') {
							return (
								<div className="terrainDoorV" key={item.id} onClick={this.handleClickDown} id={item.id}>
									{item.Player}
								</div>
							);
						} else if (item.Terrain === 'trap') {
							return (
								<div className="terrainTrap" key={item.id} onClick={this.handleClickDown} id={item.id}>
									{item.Player}
								</div>
							);
							...
							return (
								<div className="terrainLava" key={item.id} onClick={this.handleClickDown} id={item.id}>
									{item.Player}
								</div>
							);
							...
							return (
								<div className="terrainSwamp" key={item.id} onClick={this.handleClickDown} id={item.id}>
									{item.Player}
								</div>
							);
							...
							return (
								<div className="terrainGrass" key={item.id} onClick={this.handleClickDown} id={item.id}>
									{item.Player}
								</div>
							);
						} else if (item.Terrain === 'snow') {
							return (
								<div className="terrainSnow" key={item.id} onClick={this.handleClickDown} id={item.id}>
									{item.Player}
								</div>
							);
						}
				...
				<div className={this.props.display} id="gridControls">
						...
						<div className="gridButtons">
							{this.state.terrainList.map((item) => {
								if (this.state.terrainSelect === item.value) {
									return (
										<span
											onClick={() => this.handleSelectTerrain(item.value)}
											key={item.value}
					...
					<br />
					<div className="save" onClick={this.handleSaveGrid}>
						<img
							src={require('../assets/fontawesome-pro-5.6.3-web/svgs/light/save.svg')}
							alt="save"
							height="24"
						/>
					</div>
