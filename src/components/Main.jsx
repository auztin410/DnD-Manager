...
class Main extends Component {
    ...
    render() {
        ...
        if (this.state.npcComponent === true) {
            ...
            return (
                <div>
                    <div onClick={this.handled20} className="hexagonBlack"><h2 className="hexagonBlack-text">{this.state.d20[0]}</h2></div>
                        <h1 className="header" id="fadeIn" style={{height: this.state.d20[2]}}>Dungeons and Dragons Game Manager</h1>
                    <div className="buttons" id="fadeIn" style={{width: this.state.d20[1]}}>
